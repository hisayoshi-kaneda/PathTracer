...
public:
    ...
    bool isAnyImguiWindowHovered = false;
...
//その他の行列の初期化
    ...
    glm::mat4 arcMat() {
        return acTransMat * acScaleMat * acRotMat;
    }

    glm::mat4 mvMat() {
        return viewMat * acTransMat * acScaleMat * acRotMat * modelMat;
    }
